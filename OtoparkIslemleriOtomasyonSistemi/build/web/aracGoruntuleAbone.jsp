               ...
               <div class="card">
                       ...
                       <table width="100%" class="table">
                               <thead>
                                       <tr>
                                               <th>Kayit No</th>
                                               <th>Arac Sahibi Adi</th>
                                               <th>Arac Sahibi Soyadi</th>
                                               <th>Aracin Plakasi</th>
                                               <th>Arac Sahibi Mail Adresi</th><!-- comment -->
                                               <th>Arac Kayit Tarihi</th><!-- comment -->
                                               <th>arac Sahibinin Telefon Numarasi</th>
                                               <th></th>
                                       </tr>
                               </thead>
                               <tbody>
                                    ...
                                    <td><%=rs.getString("abonePlaka")%></td>
                                    <td><%=rs.getString("aboneMail")%></td><!-- comment -->
                                    <td><%=rs.getString("kayitTarihi")%></td><!-- comment -->
                                    <td><%=rs.getString("aboneTel")%></td><!-- comment -->
                                    
                                    
                                   <td class="table-action">
                                        <a href="aracDuzenle.jsp?id=<%=rs.getString("kayitNo") %>"><i class="align-middle" data-feather="edit-2"></i></a>
                                        <a href="aracSil.jsp?id=<%=rs.getString("kayitNo") %>"><i class="align-middle" data-feather="trash"></i></a>
                                    </td>
