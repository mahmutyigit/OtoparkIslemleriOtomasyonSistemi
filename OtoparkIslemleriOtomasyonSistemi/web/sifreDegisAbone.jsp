				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<a class="sidebar-link" href="aracGoruntuleAbone.jsp">
                                                    <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Aracları Görüntüle</span>
                                                </a>
                                        </li><!-- comment -->
    ...
    if("POST".equalsIgnoreCase(request.getMethod()))
    {
        if(request.getParameter("sifreDegis")!=null)
        {
            if(request.getParameter("sifreDegis").equals("Sifre Degistir"))
            {
                ...
                if((!email.isEmpty()) && (!newpass.isEmpty()) && (!newpassagain.isEmpty()))
                {
                    if(newpass.equals(newpassagain))
                    {
                        ...
                        try
                        {
                            ...
                            query = "select * from abonekaydol where email=?";
                            ...
                            if(rs.next())
                            {
                                query = "update abonekaydol set sifre=? where email=?";
                                ps = con.prepareStatement(query);
                    ...
                    <div class="card-body"   >
                                ...
                                <form id="form" method="post" action="">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="aboneid" name="email" class="form-control" >
                                        </div>
